...
//                 one: 'media one photo', two: 'media two sound',
//             },
//         };
//
...
//
//                     <Text style={styles.textSubTitle}>תאריך לידה: {figure.birthDate}</Text>
//                     <Text style={styles.textSubTitle}>תאריך פטירה: {figure.deathDate}</Text>
//                 </View>
//             </View>
//             {/* end of head Section */}
//             {/* quote */}
...
//     }, headContainer: {
//         marginTop: 10, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20,
//     }, nextText: {
//         opacity: 0,
//     }, headText: {
//         fontSize: 16,
//     }, ProgressBarContainer: {
//         marginTop: 5, width: '90%', display: 'flex', marginLeft: '5%',
//     }, ProgressBarStyle: {
...
//         marginRight: 15, marginTop: 10, alignSelf: 'flex-end',
