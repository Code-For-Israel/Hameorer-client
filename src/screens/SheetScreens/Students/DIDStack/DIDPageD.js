...
const DIDPageD = ({navigation, route}) => {
    ...
    const createFigure = () => {
        navigation.navigate('DIDPageE', {
            fullName, location, birthDate, deathDate, selectedImage,
        });
    };
                ...
                <TouchableOpacity onPress={pickImageAsync}>
                    {selectedImage ? (<View style={styles.imageContainer}>
                            <ImageViewer
                                ...
                                width={130}
                            />
                        </View>) : (<View style={styles.plusContainer}>
...
const styles = StyleSheet.create({
    container: {
        ...
        padding: 10, backgroundColor: '#f5f5f5', borderRadius: 10, fontSize: 18, textAlign: 'right',
    }, input: {
        marginBottom: 10,
        padding: 10,
