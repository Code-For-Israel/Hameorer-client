                ...
                <ScrollView style={styles.container}>
                    ...
                    <View style={styles.HeadSection}>
                        ...
                        <View style={styles.detailsContainer}>
                            ...
                            <Text style={styles.textSubTitle}>תאריך לידה: {route.params.dateBirth}</Text>
                            <Text style={styles.textSubTitle}>תאריך פטירה: {route.params.dateDeath}</Text>
                        </View>
                    </View>
                    {/* end of head Section */}
...
const styles = StyleSheet.create({
    ...
    send: {
        width: 100, marginLeft: 15, marginTop: 5,
    }, ImageContainer: {
        // flex: 1,
        // padding: 1,
