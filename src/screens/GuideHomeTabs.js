...
const GuideHomeTabs = () => {
    return (<Tab.Navigator
        ...
        screenOptions={{
            tabBarActiveTintColor: "#1261A0", tabBarIconStyle: {width: 25, paddingLeft: 5},
        }}
    >
        <Tab.Screen
            name="MyGroup"
            component={MyGroup}
            options={{
                headerShown: false, headerTitle: "הקבוצה שלי", tabBarLabel: "הקבוצה שלי", // this is the part of custom background
                headerTitleAlign: "center", headerBackground: CustomBg, headerTintColor: "#fff", //end of custom background
