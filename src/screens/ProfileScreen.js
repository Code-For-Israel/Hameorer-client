    ...
    return (<>
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={{marginRight: 20, marginBottom: 20}}>
                ...
                <Text>
                    {' '}
                    עוד יומיים ניפגש לסדנה שנייה בתהליך ההכנה נראה את הסרט ״סיפורו של נער ארטיליאי״ ונדבר מה
                    הופך ילדתמים לחלק מחבורה גזענית
                </Text>
            </View>

            <View
                style={{
                    width: 200, marginLeft: 20, paddingBottom: 20, paddingTop: 10,
                }}
            >
